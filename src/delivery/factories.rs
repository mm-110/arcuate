...
use crate::application::documentation_generator::DocumentationGenerator;
...
/// Builds a DocumentationGenerator wired with the markdown writer for both docs and index.
pub fn make_documentation_generator() -> DocumentationGenerator {
